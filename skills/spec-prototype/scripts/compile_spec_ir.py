...
def render_single_spec_md(ir: Dict[str, Any]) -> str:
    ...
    md.append("---")
    md.append("")
    md.append("## 1. Product & Architecture Context")
    ...
    md.append("---")
    md.append("")
    md.append("## 2. Sensory Calibration & Token Discipline")
    md.append("- **Five-Axis Register**:")
    ...
    md.append("---")
    md.append("")
    md.append("## 3. State Models & Action Lifecycle")
    ...
    md.append("---")
    md.append("")
    md.append("## 4. Verifiable Design Invariants & Break Protocol")
