...
- [ ] T-01 Integrate orthogonal 4-axis modern craft stack across schema, compilation, agents, and tokens
  ...
  - Write scope: skills/spec-prototype/schemas/prototype-spec.v1.json, skills/spec-prototype/scripts/compile_spec_ir.py, skills/spec-prototype/scripts/compile_tokens.py, skills/spec-prototype/scripts/assemble_envelope.py, skills/spec-prototype/agents/spec-prototype-builder.md, skills/spec-prototype/agents/spec-prototype-critic.md, skills/spec-prototype/references/stages/stage-1-frame.md, skills/spec-prototype/references/dialectic/03-sensory-kinetic.md, tests/test_tokens.py, tests/test_craft_stack.py
