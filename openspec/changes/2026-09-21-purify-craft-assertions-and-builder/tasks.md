...
- [ ] T-01 Remove category-to-craft assertions heuristic in materialize_contracts
  - Depends on: none
...
- [ ] T-02 Project device/input context into platform envelope and fix builder touch check
  - Depends on: none
...
- [ ] T-03 Remove universal craft MUSTs and contextualize state store in builder guidance
  - Depends on: none
