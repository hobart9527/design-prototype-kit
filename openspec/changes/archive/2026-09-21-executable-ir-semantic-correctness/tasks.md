...
- [x] T-01 Refactor assemble_envelope.py to enforce semantic correctness across IR fields
  - Depends on: none
...
- [x] T-02 Align agent instruction prompts and regression test suites with semantic IR
  - Depends on: T-01
