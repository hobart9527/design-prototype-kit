...
- [x] T-01 Reconnect authored contracts and slim methods into lean payload
  - Depends on: none
...
- [x] T-02 Reconcile Builder agent instructions and wire dynamic viewports to capture execution
  - Depends on: T-01
