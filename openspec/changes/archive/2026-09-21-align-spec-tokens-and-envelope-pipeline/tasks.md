...
- [x] T-01 Materialize 5-dials and reality anchors in f1.md and adapt compile_tokens
  - Depends on: none
...
- [x] T-02 Preserve reality anchors, full craft guidance, and domain constraints in assemble_envelope
  - Depends on: none
