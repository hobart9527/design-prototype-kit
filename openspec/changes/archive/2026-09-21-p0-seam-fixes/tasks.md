...
- [x] T-01 Purify f1 and r1 from unauthored universal invariants
  - Depends on: none
...
- [x] T-02 Remove domain and input assumptions in materializer ergonomics
  - Depends on: T-01
...
- [x] T-03 Eliminate unauthored cognitive ledger buzzwords and defaults
  - Depends on: T-02
...
- [x] T-04 Constrain formal token compilation to f1 source only
  - Depends on: none
