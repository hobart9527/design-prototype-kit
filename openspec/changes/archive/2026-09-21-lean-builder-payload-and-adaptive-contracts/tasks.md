...
- [x] T-01 Implement lean builder payload and adaptive inspection viewports in envelope assembly
  - Depends on: none
...
- [x] T-02 Scope in-memory state store in builder instructions to interactive surfaces
  - Depends on: none
