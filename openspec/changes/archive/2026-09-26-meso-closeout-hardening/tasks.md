...
- [x] T-01 Retire core-workflow contract entry in benchmark harness
...
- [x] T-02 Authored viewport precedence in mandatory inspection contract
...
- [x] T-03 Critic tiered evidence degradation protocol
